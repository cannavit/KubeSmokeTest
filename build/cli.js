...
const criteria_1 = __importDefault(
  require("./serviceV2/suiteGenerator/criteria")
);
const suiteGenerator_1 = __importDefault(
  require("./serviceV2/suiteGenerator/suiteGenerator")
);
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    for (const arg of args) {
      if (arg === "--help" || arg === "-h") {
        ...
        console.log(
          "--cluster-coverage   | Verify kubernetes nodes conditions "
        );
        console.log(
          "       Tests:          Description:                                        Input Required:"
        );
        console.log(
          "       --check-disk:     Check free space inside of the cluster                  No"
        );
        console.log(
          "       --check-memory:   Check if exist memory pressure                          No"
        );
        console.log(
          "       --check-disk   :  Check if exist hard disk pressure                       No"
        );
        console.log(
        ...
        console.log();
        console.log(
          "--endpoint-coverage  | Verify endpoint list  ** PENDING **"
        );
        console.log(
          "       Tests:          Description:                                        Input Required:"
        );
...
function cli(args) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    console.log(args);
    console.log("<<<<<<<<<<<<<<<<<<<");
    args = ["--cluster-coverage", "--namespace=test"];
    let options;
