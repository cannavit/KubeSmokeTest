 ...
 *          description: "successful operation"
 */
router.get("/check-pods-running", function (request, response, next) {
  return __awaiter(this, void 0, void 0, function* () {
    let args = [
      "",
      "",
 ...
 *          description: "successful operation"
 */
router.get("/check-pods-logs", function (request, response, next) {
  return __awaiter(this, void 0, void 0, function* () {
    let args = [
      "",
      "",
 ...
 *          description: "successful operation"
 */
router.get("/execution-unit-coverage", function (request, response, next) {
  return __awaiter(this, void 0, void 0, function* () {
    let args = [
      "",
      "",
