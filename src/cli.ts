...
async function printHelp(args :string[]){
  ...
  for (const arg of args) {
    ...
    if (arg === "--help" || arg === "-h"){
       ...
       console.log(" This library's to generates smoke test suites using kuernetes.") 
       ...
       console.log("       --check-pods-running:   Check if all services/pods are active           --namespace")                
       console.log()       
       console.log()
       console.log()
       console.log()
