...
const criteria_1 = require("./serviceV2/suiteGenerator/criteria");
const suiteGenerator_1 = require("./serviceV2/suiteGenerator/suiteGenerator");
...
function cli(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (continueCli) {
            ...
            options['smktestFolder'] = 'smktest';
            options['testId'] = "00120102301230123";
